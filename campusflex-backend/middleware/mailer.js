    ...
    html: `
      <div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:32px 24px;background:#f5f5fa;border-radius:20px;">
        ...
        <div style="background:#ffffff;border-radius:16px;padding:28px;text-align:center;border:1px solid #e4e4f0;">
          ...
          <p style="color:#9896b8;font-size:12px;">Expires in <strong>10 minutes</strong>. Don't share it with anyone.</p>
        </div>
        <p style="color:#9896b8;font-size:12px;margin-top:20px;text-align:center;">If you didn't sign up for CampusFlex, ignore this email.</p>
      </div>
    `,
  });
};
